...
export const updateVideoProgressAction = (videoProgress) => async (dispatch) => {
    dispatch({ type: POST_APPLICANT_PROGRESS_REQUEST_APPLICANT_PROGRESS_REQUEST });
    try {
