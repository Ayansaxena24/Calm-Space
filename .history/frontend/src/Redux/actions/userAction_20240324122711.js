...
export const updateVideoProgress = (videoProgress) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: UPDATE_VIDEO_PROGRESS_SUCCESD });
    } catch (error) {
        dispatch({
