...
import { ALL_USER_LOAD_FAIL, ALL_USER_LOAD_REQUEST, ALL_USER_LOAD_RESET, ALL_USER_LOAD_SUCCESS, POST_APPLICANT_PROGRESS_FAIL, POST_APPLICANT_PROGRESS_REQUEST, POST_APPLICANT_PROGRESS_RESET, POST_APPLICANT_PROGRESS_SUCCESS } from "../constants/userConstant"
...
export const deleteUserReducer = (state = { /* initial state */ }, action) => {
  ...
  //GET_APPLICANT_INFO_REDUCER
    ...
    //increment VideoProgress of user reducer
    export const incrementVideoProgressReducer = (state = { /* initial state */ }, action) => {
        switch (action.type) {
        // ... (other cases)
    
        case POST_APPLICANT_PROGRESS_REQUEST:
            return { ...state, loading: true };
    
        case POST_APPLICANT_PROGRESS_SUCCESS:
            return {
            ...state,
            loading: false,
            success: true,
        ...
        case POST_APPLICANT_PROGRESS_FAIL:
            return {
            ...state,
            loading: false,
            error: action.payload,
        ...
        case POST_APPLICANT_PROGRESS_RESET:
            return {
            ...state,
            success: false,
            videoProgress: null,
