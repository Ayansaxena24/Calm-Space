          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >{userInfo && userInfo.role === 1 ?
                            ...
                            (<> <MenuItem onClick={handleCloseUserMenu}>
                              ...
                              : 
                            (<> <MenuItem onClick={handleCloseUserMenu}>
                                <div textAlign="center"><Link style={{ textDecoration: "none", color: "black" }} to="/admin/dashboard">Admin Dashboard</Link></div>
                                </MenuItem> : userInfo && userInfo.role === 0 ?
                                <MenuItem onClick={handleCloseUserMenu}>
                                <Typography textAlign="center"><Link style={{ textDecoration: "none", color: "black" }} to="/user/dashboard">User Dashboard</Link></Typography>
                            </MenuItem> : userInfo && userInfo.role === 2 ?
                                <MenuItem onClick={handleCloseUserMenu}>
                                <Typography textAlign="center"><Link style={{ textDecoration: "none", color: "blacck" }} to="/creator/dashboard">Creator Dashboard</Link></Typography>
                            </MenuItem> : <></>
                            </>)
}
