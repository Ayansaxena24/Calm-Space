            ...
            return (
              <Step key={label} {...stepProps}>
                ...
                {activeStep === 0 ? ( //Personal Details
                  ...
                  >
                    <div className="absolute top-10 left-24 flex w-full">
                    <div className="border-2 shadow-xl shadow-green-300 rounded-lg w-full h-[50vh]">
                      <img src="https://i.pinimg.com/originals/bb/62/46/bb6246c85c65ddd0b35f8e6a817cb256.gif" className="h-[40vh] w-[70vh] rounded-lg" />
                    </div>
                    <div className="flex left-16 w-full justify-center pl-10 font-semibold space-x-4 right-24 text-4xl ">
