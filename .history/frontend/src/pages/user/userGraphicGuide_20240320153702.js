          ...
          {steps.map((label, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex absolute -right-64 w-full justify-center font-semibold space-x-4 top-20 text-4xl border-2">
                  <img src={timeryoga} className="h-[66vh] w-[66vh] absolute right-84 ml-4 -top-11"/>
