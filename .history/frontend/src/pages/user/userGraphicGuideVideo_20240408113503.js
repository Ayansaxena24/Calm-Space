...
import CircularDeterminate, { CircularProgressWithLabel } from "./circularProgress";
...
const UserGraphicGuideVideo = () => {
  ...
  useEffect(() => {
    ...
    const completedVideosCount = user?.videoHistory?.filter(video => video.isCompleted).length || 0;
    // Calculate progress percentage
    const newProgress = (completedVideosCount / videoUrls.length) * 100;
    console.log(completedVideosCount, videoUrls.length, newProgress, user, "qweqweqweqweqweqwe");
  ...
  return (
            ...
            return (
                ...
                {activeStep === 0 ? ( //Personal Details
                  ...
                  >
                    ...
                    <ReactPlayer
                            ...
                            onProgress={() => handleVideoProgress(videoUrls[0])}
                        />
                    </div>
              ...
              >
                ...
                <ReactPlayer
                            ...
                            style={{ position: 'absolute', top: 0, left: 0, width:"60vh", height:"60vh" }}
                            className="h-[30vh] w-[30vh]"
                            onProgress={() => handleVideoProgress(videoUrls[1])}
                        />
                </div>
                <div className="flex left-16 w-full justify-center pl-10 font-semibold space-x-4 right-24 text-4xl ">
              ...
              >
                ...
                <ReactPlayer
                            ...
                            style={{ position: 'absolute', top: 0, left: 0, width:"60vh", height:"60vh" }}
                            className="h-[30vh] w-[30vh]"
                            onProgress={() => handleVideoProgress(videoUrls[2])}
                        />
                </div>
                <div className="flex left-16 w-full justify-center pl-10 font-semibold space-x-4 right-24 text-4xl ">
                ...
                >
                  ...
                  <p className="text-[#808000] absolute left-[20vh]">Now, Relax and Meditate <br/>for 60 seconds</p>
                </div>
    ...
    <div className="flex absolute -right-64 w-full justify-center font-semibold space-x-4 top-20 text-4xl">
                  <div className="mx-10">
                  <img src={timeryoga} className="h-[66vh] w-[66vh] absolute left-80 ml-60 shadow-lg shadow-green-300 hover:shadow-violet-300 duration-300 ease-in-out -top-11 "/>
                  <CountdownCircleTimer
                  className="hover:dhadow-lg hover:shadow-violet-300 duration-300 ease-in-out ml-4"
                  isPlaying
                  duration={60}
                  size={430}
          ...
          <div className="flex justify-center items-center absolute top-[100vh]">
            <div className="relative">
              ...
              <Tilt
                      ...
                      >
            <card className="w-[60vh] h-[20vh] absolute left-4 z-20 rounded-lg bg-gradient-to-r from-[#174138] to-[#00bf8f]">
              <div className="relative">
              ...
              <div className="flex justify-center items-center h-[23vh] scale-150">
                ...
                <div className="scale-150">
                <p className="absolute top-0 opacity-0">{progress}</p>
