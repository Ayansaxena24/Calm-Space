...
You can also try a guided journal if you’d prefer more targeted, expressive writing.</p>
            ...
            <div className="w-full absolute bottom-10 flex justify-center space-x-1">
                ...
                <a href="https://buy.stripe.com/test_6oE7vk0sAen25FK144" ><p className="text-xl text-red-600 font-bold hover:text-violet-400 duration-300 ease-in-out">HERE</p></Link>
              </div>
