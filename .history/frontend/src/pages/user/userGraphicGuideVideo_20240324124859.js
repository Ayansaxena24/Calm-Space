...
const UserGraphicGuideVideo = () => {
  ...
  const updateProgress = () => {
    // Calculate the progress percentage based on completed videos
    const progress = (user?.videoProgress || 0) / videoUrls.length * 100;
    // Dispatch the action to update the progress
    dispatch(updateVideoProgressAction(progress));
  };
              ...
              <Step key={label} {...stepProps}>
                ...
                {activeStep === 0 ? ( //Personal Details
                  ...
                  >
                    ...
                    <ReactPlayer
                            url='https://www.youtube.com/watch?v=xv-ejEOogaA'
                            playing='true'
