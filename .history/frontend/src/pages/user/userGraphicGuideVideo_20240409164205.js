...
const UserGraphicGuideVideo = () => {
  ...
  return (
    ...
    <div className="flex absolute -right-64 w-full justify-center font-semibold space-x-4 top-20 text-4xl">
                  <div className="mx-10">
                  <img src={timeryoga} className="h-[66vh] w-[68vh] absolute left-80 ml-56 shadow-lg shadow-green-300 hover:shadow-violet-300 duration-300 ease-in-out -top-11 "/>
          ...
          <div className="flex justify-center items-center absolute top-[100vh]">
            <div className="relative">
              ...
              <Tilt
                      ...
                      >
            <card className="w-[60vh] h-[36vh] absolute left-4 z-20 rounded-lg bg-gradient-to-r from-[#174138] to-[#00bf8f]">
              <div className="relative">
