            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-[#808000] absolute left-[26vh]">Now, it's time for you to <br/> try it yourself</p>
                </div>
                <div className="flex absolute -right-64 bg-red-300 w-full justify-center font-semibold space-x-4 top-20 text-4xl">
