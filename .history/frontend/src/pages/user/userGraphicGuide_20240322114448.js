...
You can also try a guided journal if you’d prefer more targeted, expressive writing.</p>
            ...
            <div className="w-full absolute bottom-0 flex justify-center space-x-1">
                <p className="text-xl hover:text-violet-400 duration-300 ease-in-out">Still not Satisfied? Talk to our experts</p>
                <p className="text-xl text-red-600 font-bold">HERE</p>
              </div>
            </div>
