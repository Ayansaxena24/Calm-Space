            ...
            return (
              ...
              >
                ...
                <div className="flex absolute -right-64 w-full justify-center font-semibold space-x-4 top-20 text-4xl">
                  <div className="mx-10">
                  <img src={timeryoga} className="h-[66vh] w-[66vh] absolute left-80 ml-48 shadow-lg shadow-green-300 hover:shadow-violet-300 duration-300 ease-in-out -top-11 hover:sh"/>
