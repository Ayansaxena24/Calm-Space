              ...
              <div className="relative w-full">
                <div className="absolute top-0 w-full">
                  ...
                  <div className="absolute -top-44 left-20">
                    ...
                    <Link to={'/user/graphicGuide'}><button className={`border-2 flex flex-row bg-green-200 px-4 rounded-xl hover:scale-110 duration-300 ease-in-out ${mode === "dark" ? "text-black" : ""}`}>
