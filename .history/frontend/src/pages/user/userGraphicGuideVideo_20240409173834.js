          ...
          <div className="flex justify-center items-center absolute top-[100vh]">
            <div className="relative">
              <card className="w-[180vh] h-[40vh] p-4 rounded-lg absolute left-24 bg-gradient-to-l from-[#174138] to-[#00bf8f]">
                ...
                <card className="hover:shadow-lg hover:shadow-violet-300 hover: duration-300 ease-in-out w-[60vh] h-[36vh] absolute left-[70vh] z-20 rounded-lg bg-gradient-to-r from-[#174138] to-[#00bf8f]">
