      ...
      <Box >
        ...
        <div>
          <div className="flex justify-center items-center absolute top-[100vh]">
            ...
            <card className="w-[60vh] h-[20vh] absolute left-60 z-20 rounded-lg bg-gradient-to-r from-[#174138] to-[#00bf8f]">
              <div className="relative">
                <div className="flex justify-center items-center h-[23vh]">
