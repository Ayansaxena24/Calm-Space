      ...
      <Box >
        <Box>
          <div className="w-[205vh] relative overflow-clip">
            ...
            <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAASsAAACoCAMAAACPKThEAAAAA1BMVEUAAACnej3aAAAASElEQVR4nO3BMQEAAADCoPVPbQo/oAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAICXAcTgAAG6EJuyAAAAAElFTkSuQmCC" className="object-cover w-full h-[240vh]" /> 
            }
            <div className="flex absolute font-semibold space-x-4 text-5xl right-[42%] top-20">
              <p className="text-[#43413f]">Choose from a series of Exercises </p>
            </div>
              ...
              <Step key={label} {...stepProps}>
                ...
                {activeStep === 0 ? ( //Personal Details
                  ...
                  >
                    ...
                    <div className="flex left-16 w-full justify-center pl-10 font-semibold space-x-4 right-24 text-4xl ">
                      <p className="text-[#808000] absolute right-[34vh]">Try Journalism</p>
                    </div>
                    </div>
                    <div className="flex absolute w-full justify-center pl-10 space-x-4 right-24 text-lg top-32">
                      <p className="text-green-800 absolute right-0 w-[62vh] text-justify ">Journaling may help reduceTrusted Source stress and anxiety and provide a positive outlet for your thoughts and emotions.
...
You can also try a guided journal if you’d prefer more targeted, expressive writing.</p>
              ...
              <div className="w-[160vh] absolute top-[90vh] left-40 flex justify-between items-center">
                <div className={`flex justify-between w-full ${mode === "light" ? "text-black" : "text-black" }`}>
                  <button disabled={activeStep === 0} onClick={handleBack} className="text-black font-semibold border-2 rounded-lg hover:scale-105 duration-300 ease-in-out text-lg hover:shadow-2xl hover:shadow-violet-500 px-2">
                    Back
                  </button>
                  <button onClick={handleNext} disabled={activeStep === 3} className="font-semibold border-2 rounded-lg hover:scale-105 duration-300 ease-in-out text-lg hover:shadow-2xl hover:shadow-violet-500 px-2">
                    Next
