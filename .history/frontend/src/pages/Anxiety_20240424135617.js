      ...
      <div>
        <div className={`${mode === "dark" ? "bg-gray-800" : "bg-[#fbf8f4]"}`}>
          <div className="pt-6">
            ...
            <Button sx={{ borderRadius: '0 4px 4px 0', backgroundColor: "green", paddingX: '180px', paddingY : '10px', fontSize: '30px'}} className='rounded-r-md' variant="contained" type="submit" >
                    A N X I E T Y
                </Button>
            </div>
            <SearchInputEl />
