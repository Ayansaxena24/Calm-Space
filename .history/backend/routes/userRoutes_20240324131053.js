...
const { allUsers, singleUser, editUser, deleteUser, getApplicantInfo, changeStatus, deleteAllUsers, createUserBlogHistory, createCreatorBlogHistory } = require('../controllers/userController');
...
router.delete('/user/updateVideoProgress', deleteAllUsers)
